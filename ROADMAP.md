...
With ten certified curricula and 225 modules live (including Foundations), further curriculum work is deliberately paused for real learner and contributor feedback before it resumes — see `docs/architecture/REFERENCE_CURRICULUM_CERTIFICATION.md`'s closing note. When it does resume, the leading candidate is:
