...
A manual-testing-focused candidate, asked a security question, attempts a deep, technically specific exploit-construction answer and sounds uncertain throughout. What should they have done instead?

**Scenario 2: The Immediate Guess**

Asked "how would you investigate reports of a slow checkout page," a candidate immediately says "probably the database." What's missing from this answer?

**Scenario 3: The Flat List**

Asked "how would you test a smart thermostat," a candidate lists five generic testing types with no stated priority. What single step, if added first, would most improve this answer?

**Scenario 4: Unlimited Effort**

Given a take-home assignment with no stated time limit, a candidate spends an entire weekend producing an exhaustive, unprioritized submission with no cover note. What two specific things would have made this submission stronger?
